...
if __name__ == '__main__':
    ...
    robot_name='tb3_1'
    vel_controller_1 = VelocityController('/' + robot_name + '/odom', '/' + robot_name + '/cmd_vel')
    rospy.sleep(1.0)
    ...
    # test traj
    init_pose = Point(-6.5, 2.5, None) # <----- Initial position set in launch file
    traj_np = test_trajectory(init_pose)
    traj_np = np.load('robot1_traj.npy') # <------ CHANGE THIS
